...
const TokenDetails = () => {
    return (
        <div className='font-poppins bg-[#2C225A]'>
            <div className='flex flex-col space-y-4 justify-center items-center'>
                <div className='text-[#00D4FF] font-medium'>SOCIA Details</div>
                <div className='text-white text-3xl font-medium'>SOCIA Token Details</div>
                <div className='text-white text-center '>Our platform ensures data privacy, censorship resistance, and user empowerment</div>
                <div className='flex md:flex-row flex-col gap-8 py-6 px-4'>
                    <div className='w-full md:w-2/5 flex flex-col space-y-6 text-white bg-[#33295F] border px-4 py-8 rounded-lg border-[#40376D]'>
                        ...
                        <div className='flex flex-col justify-start items-start bg-[#40376D] p-4 rounded-lg'>
                            <h1 className='text-xl font-semibold'>Number Of Tokens For Sale</h1>
